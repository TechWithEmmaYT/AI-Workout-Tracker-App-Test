      ...
      >
        {workout?.image ? (
          <View className="h-64 bg-muted">
            <Image
              accessibilityLabel={`${workout.name} workout cover`}
          ...
          <View className="h-64 items-center justify-center bg-muted">
            <Feather color={muted} name="image" size={40} />
          </View>
        )}
  ...
  return (
    ...
    >
      ...
      <View className="px-5">
        ...
        <Skeleton className="mb-3 mt-4 h-16 w-full rounded-xl" />
        {Array.from({ length: 5 }).map((_, index) => (
          <Skeleton className="mt-2 h-16 w-full rounded-xl" key={index} />
        ))}
      </View>
    </ScrollView>
  );
